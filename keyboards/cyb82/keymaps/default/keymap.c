...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KEYMAP(
		...
		KC_ESC, KC_F1, KC_F2, KC_F3, KC_INS, KC_HOME, KC_PGUP, KC_HOME, KC_NO, KC_PGUP,
		KC_F4, KC_F5, KC_F6, KC_DEL, KC_END, KC_PGDN, KC_NO, KC_5, KC_NO,
		KC_F7, KC_F8, KC_F9, KC_NO, KC_END, KC_NO, KC_PGDN,
		KC_F10, KC_F11, KC_F12, KC_NO, KC_NO, KC_NO, KC_END, KC_NO, KC_DEL),
